...
>>>>>>> 77f2dccc581a2e305d374991d500b386bf49b3ad
    ...
    #ggtitle('podemos')
  print(g) 
  ggsave(file=paste0('ch4_degree_distribution_podemos.png'), 
...
>>>>>>> 77f2dccc581a2e305d374991d500b386bf49b3ad
    ...
    print(g)
    ggsave(file=paste0('ch4_subtreesize_distribution_podemos.png'), 
           width=200, height=70, units='mm')
    g
}
...
>>>>>>> 77f2dccc581a2e305d374991d500b386bf49b3ad
  ...
  print(g)
  ggsave(file=paste0('ch4_depth_by_size_podemos.png'), 
         width=200, height=70, units='mm')
  g
}
